...
@mcp.tool()
async def get_streams(project_name: str = "") -> str:
    """
...
@mcp.tool()
async def get_defect_details(cid: str, project_name: str) -> str:
    """
...
@mcp.tool()
async def get_scan_summary(project_name: str, stream_name: str = "") -> str:
    """
